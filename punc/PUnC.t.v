...
module PUnCTATest;
	...
	initial begin
		...
		`WAIT_PC_FREEZE;
		`ASSERT_MEM_EQ(19, 16'd108);
		`ASSERT_MEM_EQ(20, 16'd109);
		`ASSERT_MEM_EQ(21, 16'd110);
		`ASSERT_MEM_EQ(22, 16'd111);
		`ASSERT_MEM_EQ(23, 16'd112);
		`ASSERT_MEM_EQ(24, 16'd113);
		`ASSERT_MEM_EQ(25, 16'd114);
		`ASSERT_MEM_EQ(26, 16'd115);
		`ASSERT_MEM_EQ(27, 16'd116);
		`ASSERT_MEM_EQ(28, 16'd117);
		`ASSERT_MEM_EQ(29, 16'd118);
		`ASSERT_MEM_EQ(30, 16'd119);
		`ASSERT_MEM_EQ(31, 16'd120);
		`ASSERT_MEM_EQ(32, 16'd121);
		`ASSERT_MEM_EQ(33, 16'd122);
		`ASSERT_MEM_EQ(34, 16'd97);
		`ASSERT_MEM_EQ(35, 16'd98);
		`ASSERT_MEM_EQ(36, 16'd99);
		`ASSERT_MEM_EQ(37, 16'd100);
		`ASSERT_MEM_EQ(38, 16'd101);
		`ASSERT_MEM_EQ(39, 16'd102);
		`ASSERT_MEM_EQ(40, 16'd103);
		`ASSERT_MEM_EQ(41, 16'd104);
		`ASSERT_MEM_EQ(42, 16'd105);
		`ASSERT_MEM_EQ(43, 16'd106);		
		`ASSERT_MEM_EQ(44, 16'd107);
